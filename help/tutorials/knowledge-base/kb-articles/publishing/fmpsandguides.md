---
title: Veröffentlichen mit FrameMaker Publishing Server (FMPS) in AEM Handbüchern
...
# Veröffentlichen mit FrameMaker Publishing Server (FMPS) in AEM Handbüchern
...
>Wenn Sie UUID verwenden, stellen Sie sicher, dass Sie in den FrameMaker-Bearbeitungseinstellungen die Option &quot;UUID-basierte Referenzierung verwenden&quot;und in den Handbüchern ohne UUID-AEM umgekehrt aktiviert haben.
...
>Stellen Sie sicher, dass Ihre Grundlinie ordnungsgemäß erstellt wurde. um dies zu überprüfen, gehen Sie zum Map Dashboard - Themen - Karte herunterladen und wählen Sie &quot;Grundlinie verwenden&quot;.
- ### Veröffentlichungsaufgaben aus FMPS benötigen mehr Zeit als andere Engines

>Beim Veröffentlichen über FMPS beträgt die ideale feste Header-Zeit ca. 3-4 Minuten. Wenn Sie glauben, dass es länger ist, wenden Sie sich an Ihren FMPS-Administrator oder kontaktieren Sie den Adobe Support.
