...
- Klicken **Schließen** , um zur Seite &quot;Posteingang&quot;zu wechseln.
...
- Klicken **Aktualisieren** , um die aktualisierte Version des Themas für die Prüfer freizugeben. Die validierungsverantwortlichen Benutzer erhalten eine E-Mail-Benachrichtigung, dass die neuere Version des Themas zur Überprüfung gesendet wurde. Wenn ein Prüfer das Thema das nächste Mal öffnet, wird ihm die aktualisierte Version des Themas angezeigt.
...
- Klicken **Duplizieren** , um eine neue Prüfungsaufgabe zu erstellen, die die aktuelle Aufgabe als Basis verwendet.
...
- **Alle auswählen**: Wählt alle Themen in der Themenliste aus. Sie können einfach einen Batch-Vorgang ausführen, nachdem Sie alle Themen ausgewählt haben.
...
- **Überprüfer bearbeiten**: Klicken Sie auf ![](images/edit_pencil_icon.svg)-Symbol in der Themenliste wird das Dialogfeld &quot;Überprüfer bearbeiten&quot;angezeigt. Sie können Überprüfer für das ausgewählte Thema in diesem Dialogfeld hinzufügen oder entfernen.
...
- Die Spalte Status gibt den Prüfungsstatus an. Der Status kann einer der folgenden sein:
   ...
   - **Fertig**: Der Überprüfer hat die Überprüfung abgeschlossen, indem er die ihm zugewiesene Überprüfungsaufgabe abgeschlossen hat. Die Überprüfungsaufgabe befindet sich für jeden Überprüfer im Posteingang für AEM Benachrichtigungen.
